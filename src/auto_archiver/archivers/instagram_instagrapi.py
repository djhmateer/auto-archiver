    ...
    **NOTE - need to put in username and password in download_post method hard code in here for now**
    ...
    def download(self, item: Metadata) -> Metadata:
        ...
        if g1 == "" and g2 =="s" and g3 == "":
            message = f'Instagram_api - short code not implemented. Try linking directly to the story or post ie not an instagram/s/ link, where the s stands for short code'
